if IsClient() then 
	...
	com.game.Client.RuntimeTexture.Register = RegisterRuntimeTexture
	com.game.Client.RuntimeTexture.GetLastIndex = GetLastIndexOfRuntimeTexture
	com.game.Client.RuntimeTexture.SetData = SetRuntimeTextureData
	com.game.Client.RuntimeTexture.Draw = DrawRuntimeTexture
	com.game.Client.RuntimeTexture.Undraw = UnDrawRuntimeTexture
end 